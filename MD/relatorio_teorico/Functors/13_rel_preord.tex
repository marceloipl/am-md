\section{Funtor \texorpdfstring{$F: Rel \to PreOrd$}{F: Rel -> PreOrd}}
...
\subsection{Funtor Covariante \texorpdfstring{$F: Rel \to PreOrd$}{F: Rel -> PreOrd - (Fechamento Reflexivo-Transitivo)}}
