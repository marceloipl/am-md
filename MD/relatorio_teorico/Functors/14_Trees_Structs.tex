\section{Funtor \texorpdfstring{$G: Trees \to Struct$}{G: Trees -> Struct}}
...
\subsection{Funtor Covariante \texorpdfstring{$G: Trees \to Struct$}{G: Trees -> Struct} (Codificação como Conjunto Estruturado)}
