\section{Funtor \texorpdfstring{$H: End \to Struct$}{H: End -> Struct}}
...
\subsection{Funtor Covariante \texorpdfstring{$H: End \to Struct$}{H: End -> Struct} (Endomorfismo como Conjunto Estruturado)}
