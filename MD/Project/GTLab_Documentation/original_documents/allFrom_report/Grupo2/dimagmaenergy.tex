...
\subsection{Type of Analysis Performed}
...
\textbf{GELU (Gaussian Error Linear Unit)} is used as the hidden-layer activation function, which is common in modern neural architectures.
...
\[
\text{Input} \rightarrow W_1 \rightarrow \text{Hidden Layer} \rightarrow W_2^{(1..n)} \rightarrow \text{Hidden Stack} \rightarrow W_3 \rightarrow \text{Softmax}
\]
...
\section{Backpropagation Function}
...
\subsection{Training Performance Plots}
