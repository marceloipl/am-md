...
\chapter{MATLAB Code Analysis: endomaps_exe.m}
...
\end{itemize}
\begin{itemize}
    \item Graph Theory and Homology: Visualizing relations as directed graphs and analyzing their connected components.
\end{itemize}
...
\subsection*{ \hspace*{0.2cm} Block 1: Input Validation and Default Initialization}
...
\subsubsection*{Console Outputs:}
    ...
    \subsubsection*{Visual Outputs (Plots)}
        \begin{itemize}
     ...
     \begin{itemize}
             ...
             \begin{itemize}
                 Top Plot: Titled "correction for the failure of anti-symmetry". This visualizes the cyclic, mutually-related nodes being grouped into unified equivalence classes.
             \end{itemize}
             
             \begin{itemize}
                 Bottom Plot: This represents the formal Hasse diagram of the resulting antisymmetric partial order $R_{anti}$. The axes generally don't have standard numerical meanings here; instead, the $Y$-axis visually represents the hierarchical "level" or rank of the partial order, with directed edges flowing downwards or upwards to denote the $\leq$ relation between the clustered endomap classes.
             \end{itemize}
    \end{itemize}
