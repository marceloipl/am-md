...
\chapter{MATLAB Code Analysis: \texttt{dlinktopology.m}}
\date{}
...
\subsection{Function Signature and Basic Initialization}
...
\textbf{Explanation:} Computes the discrete Levi-Civita connection (\texttt{Civitta}), which tracks phase shifts as tangent vectors are parallel-transported across the mesh. It then builds the cotangent-weighted adjacency matrix \texttt{W}, forces it to be perfectly symmetric, and extracts the final discrete Graph Laplacian \texttt{L} by subtracting the degree matrix.
