...
\chapter{Technical Analysis of MATLAB Script: \texttt{links2surf.m}}
\author{}
\date{}
...
\begin{itemize}
    \item \textbf{Main Purpose}: To construct a 3D surface by sweeping a "generatrix" curve (profile) along a "mother" curve (path).
    \item \textbf{Type of Analysis}: The script performs geometric extrusion and coordinate transformations. It calculates tangent vectors and rotation angles to ensure the generating curve is placed orthogonally relative to the direction of the mother curve.
