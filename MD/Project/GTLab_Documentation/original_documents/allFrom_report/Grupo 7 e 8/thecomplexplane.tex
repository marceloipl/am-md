...
\chapter{MATLAB Code Analysis: \texttt{thecomplexplane.m}}
\date{}
...
\subsection{1. Section/Function Title: Cardinality Initialization}
...
\subsection{2. Section/Function Title: Bijections ($i2s$ and $s2i$)}
...
\subsection{3. Section/Function Title: Auxiliary Map $f: X \to \mathbb{Z}$}
...
\subsection{4. Section/Function Title: Auxiliary Map $g: B \to \mathbb{C}$}
...
\subsection{5. Section/Function Title: The Complex Map $F: A \to \mathbb{C}$}
...
\subsection{6. Section/Function Title: Example Execution and Plotting}
