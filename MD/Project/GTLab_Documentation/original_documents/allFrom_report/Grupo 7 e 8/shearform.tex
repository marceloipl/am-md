...
\subsubsection*{1. Section/Function Title: Argument Initialization and Defaults}
...
\subsubsection*{2. Section/Function Title: Rotation, Scaling, and Translation}
...
\subsubsection*{3. Section/Function Title: Shear Deviation Calculation (Contains a Bug)}
...
\subsubsection*{4. Section/Function Title: Final Transformation and Recombination}
...
\begin{itemize}
    ...
    \item \textbf{As-Is Visual Output (Due to the bug):} 
    ...
    \item \textbf{Intended Visual Output (If the bug is fixed):}
