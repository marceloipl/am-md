...
\chapter{Análise do Código MATLAB: \texttt{plane2sphere.m}}
\section{Code Visão Geral}
...
\subsection{1. Entrada Parsing and Complex Number Handling}
\textbf{Explanation:} 
...
\subsection{4. Saída Aggregation}
\textbf{Explanation:} 
